...
await page.waitForFunction(
  () => customElements.get('dotrino-support') && document.querySelector('#auto')?.shadowRoot?.querySelector('.trigger'),
  null,
  { timeout: 5000 },
)
...
// 1. registrado
results.defined = await page.evaluate(() => !!customElements.get('dotrino-support'))
